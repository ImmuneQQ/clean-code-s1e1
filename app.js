...
var taskInput=document.querySelector(".tasks_add .tasks__input_text");//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.querySelector(".list_incomplete");//ul of #incomplete-tasks
...
var editTask=function(){
  ...
  if(containsClass){
    ...
    listItem.className="list__item_edit-mode";
  }
};
